...
/**
 * Prints a particular instance of feedbackccna
 *
...
//$PAGE->add_body_class('feedbackccna-'.$somevar);

// Output starts here
echo $OUTPUT->header();

if ($feedbackccna->intro) { // Conditions to show the intro can change to look for own settings or whatever
    echo $OUTPUT->box(format_module_intro('feedbackccna', $feedbackccna, $cm->id), 'generalbox mod_introbox', 'feedbackccnaintro');
}
